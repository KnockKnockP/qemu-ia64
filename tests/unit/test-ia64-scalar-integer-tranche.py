...
"""Independent E2 execution for the IA-64 scalar-integer tranche."""
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    manifest = json.loads((root / "tests/ia64-conformance/scalar-integer-tranche.json").read_text(encoding="utf-8"))
    harness = load_module(root / "tests/unit/test-ia64-full-tcg.py", "_ia64_scalar_integer_tranche_harness")
    scalar = load_module(root / "tests/unit/test-ia64-scalar-tcg.py", "_ia64_scalar_integer_tranche_probes")
