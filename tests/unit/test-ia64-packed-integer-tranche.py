...
"""Independent E2 execution for the IA-64 packed-integer tranche."""
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    manifest = json.loads((root / "tests/ia64-conformance/packed-integer-tranche.json").read_text(encoding="utf-8"))
    harness = load_module(root / "tests/unit/test-ia64-full-tcg.py", "_ia64_packed_integer_tranche_harness")
    packed = load_module(root / "tests/unit/test-ia64-packed-tcg.py", "_ia64_packed_integer_tranche_probes")
