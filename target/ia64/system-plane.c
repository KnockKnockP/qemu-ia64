...
static uint64_t ia64_pmu_pmc_writable_mask(unsigned index)
{
    if (index == 0) {
...
static uint64_t ia64_pmu_pmd_writable_mask(unsigned index)
{
                                         ...
                                         uint64_t index)
{
    ...
    case IA64_OP_MOV_PMCGR_INDEXED:
        ...
        return env->pmc[index] & ia64_pmu_pmc_writable_mask(index);
    case IA64_OP_MOV_PMDGR_INDEXED:
        ...
        return env->pmd[index] & ia64_pmu_pmd_writable_mask(index);
