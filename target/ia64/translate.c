...
static bool ia64_pc_is_efi_call_gate(uint64_t pc)
{
    ...
    if (pc < VIBATNIUM_EFI_CALL_GATE_BASE) {
        return false;
    }

    offset = pc - VIBATNIUM_EFI_CALL_GATE_BASE;
