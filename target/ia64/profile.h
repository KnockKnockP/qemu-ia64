...
typedef enum IA64ProfileCounter {
    ...
    IA64_PROFILE_SHAPE_C_RSE_GROUP,
    IA64_PROFILE_SHAPE_C_RSE_SLOT,
    IA64_PROFILE_SHAPE_C_RFI_GROUP,
    IA64_PROFILE_SHAPE_C_RFI_SLOT,
    IA64_PROFILE_SHAPE_C_SYSTEM_GROUP,
    IA64_PROFILE_SHAPE_C_SYSTEM_SLOT,
    ...
    IA64_PROFILE_SHAPE_C_PLUGIN_GROUP,
    IA64_PROFILE_SHAPE_C_PLUGIN_SLOT,
    ...
    IA64_PROFILE_SHAPE_C_UNKNOWN_GROUP,
    IA64_PROFILE_SHAPE_C_UNKNOWN_SLOT,
